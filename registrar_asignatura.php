...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/cuerpo_registrar_asignatura.css">
...
<body>
  ...
  <div id="cuerpo">
    <section>
      <div id="formulario">
      <p class="titulo"><b>Registrar Asignatura:</b></p><hr></hr>
        <form class="captura" action="php/Controlador/CrearAsignatura.php" method="post" name="captura">
          ...
          <strong><label for="cbplan">Plan:</label></strong>
            <select name="cbplan">
              <?php
